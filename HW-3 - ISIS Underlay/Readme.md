...
| Устройство                 | Loopback 0 (IS-IS) | Loopback 10 (VTEP) |
|----------------------------|--------------------|--------------------|
...
<details><summary>Контекст для коммутаторов из нашей схемы</summary>

Преобразование адреса 10.16.0.1 

    {
      "isis_id": "0101.6000.0001"
    }

Преобразование адреса 10.16.0.2


    {
      "isis_id": "0101.6000.0002"
    }

Преобразование адреса 10.16.1.1

    {
      "isis_id": "0101.6000.1001"
    }

Преобразование адреса 10.16.1.2

    {
      "isis_id": "0101.6000.1002"
    }

Преобразование адреса 10.16.1.3
    
    {
      "isis_id": "0101.6000.1003"
    }
